...
! RUN: %flang --target=x86_64-unknown-linux-gnu -mamx-transpose -### %s 2>&1 \
! RUN:     | FileCheck -check-prefix=AMX-TRANSPOSE %s
! RUN: %flang --target=x86_64-unknown-linux-gnu -mno-amx-transpose -### %s 2>&1 \
